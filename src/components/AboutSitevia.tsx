        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-slate-200/80 dark:border-slate-800">
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white mt-1">
                  {lang === 'en' ? 'Webvia started with a simple idea:' : 'वेबविया की शुरुआत एक सरल विचार से हुई:'}
                </h3>
              </div>
            ...
            <p className="text-base text-slate-700 dark:text-slate-300 leading-relaxed mb-8 font-normal">
              {lang === 'en' ? (
                <>
                  That’s why <strong className="text-slate-900 dark:text-white">Webvia</strong> was created — to make professional websites and online systems <span className="underline decoration-blue-500 decoration-2 underline-offset-4 font-semibold">simple, affordable, and actually useful</span> for every small business.
                </>
              ) : (
                <>
                  इसीलिए <strong className="text-slate-900 dark:text-white">वेबविया (Webvia)</strong> का जन्म हुआ — ताकि पेशेवर वेबसाइट्स और ऑनलाइन सिस्टम्स को हर छोटे व्यवसाय के लिए <span className="underline decoration-blue-500 decoration-2 underline-offset-4 font-semibold">सरल, किफायती और बेहद उपयोगी</span> बनाया जा सके।
                </>
              )}
            </p>
          ...
          {/* Section 2: Struggles vs Webvia Solutions (Interactive Comparison Grid) */}
          <div className="text-center mb-10">
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mt-2 max-w-xl mx-auto">
              {lang === 'en'
                ? 'We saw business owners losing sales due to 4 critical bottlenecks. Here is how Webvia transforms them into revenue.'
                : 'हमने देखा कि 4 मुख्य कारणों से बिजनेस का नुकसान हो रहा था। देखिए वेबविया इसे कैसे मुनाफे में बदलता है।'}
            </p>
          </div>
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            <span className="text-[10px] uppercase font-black tracking-wider text-emerald-700 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-900/50 px-2 py-0.5 rounded-md">
                              {lang === 'en' ? 'WEBVIA SOLUTION' : 'वेबविया समाधान'}
                            </span>
                          </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3.5 w-full sm:w-auto">
              <MagneticButton
                href={createQuickWhatsAppUrl('Hi Webvia! I read your story and I want to build a website for my business.')}
                target="_blank"
